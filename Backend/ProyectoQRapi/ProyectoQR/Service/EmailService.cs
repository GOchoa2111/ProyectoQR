                    ...
                    <div style='max-width:600px;margin:0 auto;border:1px solid #e6e6e6;border-radius:8px;overflow:hidden;'>
                        ...
                        <div style='padding:20px;background:#fff;'>
                            ...
                            <p style='margin:18px 0;'>
                                <a href='https://uregionalsga.duckdns.org/login' style='display:inline-block;padding:10px 16px;background:#ea8a1a;color:#fff;border-radius:6px;text-decoration:none;font-weight:600;' target='_blank' rel='noopener noreferrer'>Ir al sistema</a>
                            </p>
